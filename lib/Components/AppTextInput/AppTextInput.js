...
// create a component
const AppTextInput = ({ inputStyle, mainContainerStyle, leftIcon, placeholderTextColor = '#999', rightAction, rightActionButtonStyle, inputContainerStyle, onRightIconPress, title, allowFontScaling = false, titleStyle, value, onChnageText, ...props }) => {
