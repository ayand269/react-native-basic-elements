...
const MultiSelectDropdown = ({ options = [], valueKey = 'value', labelKey = 'label', returnDataType = (item) => { return { value: item[valueKey] }; }, onValueChange, selectedValues, modalContainerStyle = {}, inputContainerStyle = {}, placeholder = 'Choose', placeholderStyle = {}, closeIcon = defaultCloseIcon, modalHeading = 'Choose', itemContainerStyle = {}, itemTextStyle = {}, selectedIcon = defaultCkeckIcon, modalHeadingTitle = {} }) => {
