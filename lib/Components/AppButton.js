...
const AppButton = ({ title, shadow = false, gradient = false, gradientColors = [], style, gradientEnd, gradientStart, gradientLocation, textStyle, loader, buttonIcon, ripple, onPress, ...props }) => {
