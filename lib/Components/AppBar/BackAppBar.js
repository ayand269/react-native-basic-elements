...
const BackAppBar = (props) => {
    const { title, titlePosition = 'middle', backgroundColor, style, icon, onLeftIconPress, barStyle, titleStyle, titleType = 'text', titleImage, titleImageStyle, rightActions = [], shadow, statusBarHidden = false, statusBarTranslucent = false, subTitle, subTitleStyle, imageTitleContainerStyle, leftIconContainerStyle = {} } = props;
    ...
    return (React.createElement(View, { style: [
        ...
        React.createElement(View, { style: [
            ...
            React.createElement(Pressable, { style: leftIconContainerStyle, onPress: onLeftIconPress ? onLeftIconPress : null },
