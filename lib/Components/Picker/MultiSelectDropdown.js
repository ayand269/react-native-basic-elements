...
const MultiSelectDropdown = ({ options = [], valueKey = 'value', labelKey = 'label', returnDataType = (item) => { return item[valueKey]; }, onValueChange, selectedValues, modalContainerStyle = {}, inputContainerStyle = {}, placeholder = 'Choose', placeholderStyle = {}, closeIcon = defaultCloseIcon, modalHeading = 'Choose', itemContainerStyle = {}, itemTextStyle = {}, selectedIcon = defaultCkeckIcon, modalHeadingTitleStyle = {}, modalBackgroundColor = '#fff', modalHeaderShadow = true }) => {
