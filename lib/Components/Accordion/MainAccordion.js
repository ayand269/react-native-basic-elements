...
const MainAccordion = ({ children, title, leftIcon, style, openIcon = openedIcon, closeIcon = closedIcon, titleStyle, containerStyle, customElement = null, bottomElement = null, shadow = false }) => {
