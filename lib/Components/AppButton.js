...
const AppButton = ({ title, shadow = false, gradient = false, gradientColors = [], style, gradientEnd, gradientStart, gradientLocation, textStyle, loader, buttonIcon, ripple, onPress, customeElement, ...props }) => {
    ...
    return (React.createElement(React.Fragment, null, gradient ?
        React.createElement(LinearGradient, { style: [
                ...
                style
            ], colors: gradientColors, start: gradientStart, end: gradientEnd, locations: gradientLocation, onTouchEnd: onPress ? onPress : undefined },
            (loader === null || loader === void 0 ? void 0 : loader.position) == 'left' ?
                ...
                :
                    null,
            (customeElement === null || customeElement === void 0 ? void 0 : customeElement.position) == 'left' ?
                customeElement === null || customeElement === void 0 ? void 0 : customeElement.children
                :
            ...
            title ?
                ...
                :
                    null,
            (customeElement === null || customeElement === void 0 ? void 0 : customeElement.position) == 'right' ?
                customeElement === null || customeElement === void 0 ? void 0 : customeElement.children
                :
        ...
        :
            React.createElement(Pressable, { style: [
                    ...
                    style
                ], onPress: onPress ? onPress : null, ...props },
                (loader === null || loader === void 0 ? void 0 : loader.position) == 'left' ?
                    React.createElement(ActivityIndicator, { style: {
                            marginRight: 10,
                            ...loader.style
